...
export function Price({ amount, locale }: { amount: number; locale?: SupportedLocale | undefined }) { return <span className="text-price text-foreground">{formatPrice(amount, locale)}</span>; }
